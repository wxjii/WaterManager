...
public class Shore {
    ...
    public Shore(int sId, double sPh, double sSuspension, double sBod, double sCod, double sToc, double sAmmonia, double sPhosphate, double sTemperature, double sConductivity, double sTurbidity, double sDissolved, double sPetroleum, double sAlage, double sChlorophyll, double sNitrogen, double sNitriteNitrogen, LocalDateTime sDate) {
        this.sId = sId;
        this.sPh = sPh;
        this.sSuspension = sSuspension;
        this.sBod = sBod;
